...
ActiveRecord::Schema.define(:version => 142) do
  ...
  create_table "candidates", :force => true do |t|
    ...
    t.column "study_theme",            :string,   :limit => 1000
    t.column "note",                   :text
    t.column "created_on",             :datetime
    t.column "updated_on",             :datetime
  ...
  create_table "exams", :force => true do |t|
    ...
    t.column "passed_on",            :datetime
    t.column "third_examinator_id",  :integer
    t.column "fourth_examinator_id", :integer
  end
  ...
  create_table "interupts", :force => true do |t|
    t.column "index_id",     :integer
    t.column "note",         :string,   :limit => 512
    t.column "created_on",   :datetime
    t.column "updated_on",   :datetime
  ...
  create_table "statements", :force => true do |t|
    t.column "note",       :string,   :limit => 1023
    t.column "result",     :integer
    t.column "person_id",  :integer
    t.column "created_on", :datetime
    t.column "updated_on", :datetime
