...
describe CentralRegister::Department do
  ...
  context "when parsing correct response" do
    before do
      mock_service <<BODY
<soap:departmentResponse xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <departments>
    <department>
      <id>2</id>
...
</soap:departmentResponse>
BODY
    end
    it "it returns array of department hashes" do
      CentralRegister::Department.all.should == [
        {
...
BODY
    ...
    it "should not raise error" do
      lambda {CentralRegister::Department.all}.should_not raise_error
    end
  end
